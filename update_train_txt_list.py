...
# 定义输入训练清单的路径
input_txt_path    = u"/Users/congjt/GOTURN-Tensorflow/train/train.txt"

# 定义参考干净数据集的根路径
input_ref_path    = u"/Volumes/E/尤晶晶图片备份/跟踪清洗数据/干净数据"

# 定义输出训练清单的路径
output_txt_path   = u"/Users/congjt/GOTURN-Tensorflow/train/train_update_0207.txt"

# 定义输出的垃圾数据的路径
output_trash_path = u"/Users/congjt/GOTURN-Tensorflow/train_trash_0207"
    ...
    with open(output_txt_path, "w") as fin:
        ...
        with open(input_txt_path, u"r") as f:
            ...
            for one_line in f.readlines():
                ...
                # 解析出模板图像文件路径
                exampleimg_path = os.path.join("/Users/congjt/GOTURN-Tensorflow",split_line[0])
                # 解析出搜索图像文件路径
                searchimg_path  = os.path.join("/Users/congjt/GOTURN-Tensorflow",split_line[1])
